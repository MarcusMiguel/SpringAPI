...
function cancelCart(shopid, productid) {
    $.ajax({
        type: "POST",
        url: "https://marcusmiguel-restapi.herokuapp.com/api/v1/carts/remove/" + shopid + "/" + productid,
...
function addToCart(shopid, productid, quantity) {
    $.ajax({
        type: "POST",
        url: "https://marcusmiguel-restapi.herokuapp.com/api/v1/carts/insert/" + shopid + "/" + productid + "/" + quantity,
         success: function (data) {
            var shopproductsrow = '#shop-products-row'+shopid
